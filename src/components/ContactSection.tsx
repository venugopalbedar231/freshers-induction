    ...
    <section id="contact" className="py-16 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="iit-card p-8 border-l-4 border-iit-blue">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-heading font-bold text-iit-blue">
                  Help Desk
                </h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <p className="text-red-700 text-sm">
                    ...
                    Medical emergencies, security concerns, or any urgent assistance needed during the induction program.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Volunteer Contacts */}
          <div className="mb-12">
            <h3 className="text-2xl font-heading font-bold text-iit-blue mb-6 text-center">
              Volunteer Contacts
            </h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {officials.map((official, index) => (
                <div key={index} className="iit-card p-6 text-center">
                  ...
                  <h4 className="font-heading font-bold text-iit-blue mb-2">
                    {official.name}
                  </h4>
                  <p className="text-sm text-iit-blue/70 mb-4">
                    {official.title}
                  </p>
          ...
          <div className="mt-12 bg-gradient-to-r from-iit-gold/10 to-iit-copper/10 rounded-xl p-8 border border-iit-gold/20">
            <h4 className="text-xl font-heading font-bold text-iit-blue mb-4 text-center">
              Important Contact Information
            </h4>
            <div className="grid md:grid-cols-2 gap-6 text-sm text-iit-blue/80">
              <div>
                <h5 className="font-semibold mb-2">Before Arrival:</h5>
                <p>• For general queries, contact the help desk email</p>
                <p>• Travel and accommodation: gs.welfare@iitkgp.ac.in</p>
                <p>• Academic queries: academic.section@iitkgp.ac.in</p>
              </div>
              <div>
                <h5 className="font-semibold mb-2">During Induction:</h5>
                <p>• Volunteers will be available at all major locations</p>
                <p>• Help desk operates from registration area</p>
                <p>• Emergency contacts available 24/7</p>
              </div>
            </div>
          </div>
        </div>
