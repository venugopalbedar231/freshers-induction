  ...
  const schedule = [
    {
      ...
      activity: "Invitation of Dignitaries to the Dias Lighting of the Lamp & Vandana",
    ...
    },
    {
      ...
      activity: "Break & Know the Facility",
      venue: "Netaji Auditorium, Raman & Bhatnagar Auditoriums (All Students) Kalidas Auditorium (Parents)",
      description: "",
    },
    {
      date: "19/07/2025",
      time: "11:25 am - 12:00 noon",
      activity: "FUNDAE sessions",
      venue: "Netaji Auditorium, Raman & Bhatnagar Auditoriums (All Students) Kalidas Auditorium (Parents)",
      description: "Dean SA",
    },
    {
