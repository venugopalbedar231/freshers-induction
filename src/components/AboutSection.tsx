...
const AboutSection = () => {
  const objectives = [
    ...
    "Introduce the rich culture and traditions of IIT Kharagpur",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-lg text-iit-blue/70 max-w-3xl mx-auto">
              Welcome to IIT Kharagpur! Our comprehensive induction program is designed to help you 
              transition smoothly into academic life at one of India's premier institutions.
            </p>
          </div>
          ...
          <div className="iit-card p-8 md:p-12 mb-12 border-l-4 border-iit-blue">
            <div className="mb-8">
              ...
              <p className="text-iit-blue/80 leading-relaxed text-lg">
                The transition from school to a premier technical institute like IIT Kharagpur can be 
                overwhelming. Our induction program serves as a bridge, helping you understand the 
                academic culture, explore opportunities, and build lasting relationships that will 
                define your journey at IIT KGP.
              </p>
            </div>
          ...
          {/* Important Notes */}
          <div className="bg-gradient-to-r from-iit-gold/10 to-iit-copper/10 rounded-xl p-8 border border-iit-gold/20">
            <h4 className="text-xl font-heading font-bold text-iit-blue mb-4 flex items-center">
              <BookOpen className="w-6 h-6 mr-3 text-iit-gold" />
              Important Notes
            </h4>
            <div className="space-y-3 text-iit-blue/80">
              <p>• Attendance is mandatory for all first-year students</p>
              <p>• Bring your admission documents and ID proof</p>
              <p>• Comfortable clothing and footwear recommended for campus tours</p>
              <p>• Stay hydrated and carry a water bottle</p>
              <p>• Be punctual and follow the schedule provided</p>
            </div>
          </div>
        </div>
      </div>
